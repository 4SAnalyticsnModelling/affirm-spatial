...
The input variables are provided in the default `input/AFFIRM-batch-inputs-tabs.txt` or `input/AFFIRM-batch-inputs-commas.txt` file. Visit [AFFIRM Lite](https://www.4sanalyticsnmodelling.com/affirm-lite/) to understand these variables better.
